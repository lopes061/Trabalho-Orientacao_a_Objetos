...
public class MenuAluno {
	...
	private static String lerCurso() {
		return String JOptionPane.showInputDialog("Informe o curso do aluno: ");
	}

	private static String lerEmail() {
		return String JOptionPane.showInputDialog("Informe o email do aluno: ");
	}

	private static String lerNome() {
		return String JOptionPane.showInputDialog("Informe o nome do aluno: ");
	}

	private static String lerMatricula() {
		return String JOptionPane.showInputDialog("Informe a matricula do aluno: ");
	}
